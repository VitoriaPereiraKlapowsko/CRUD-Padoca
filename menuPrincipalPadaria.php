    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #651b32;">
        ...
        <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="cardapio.php" style="color: white;">Cardápio<span class="sr-only"></span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="aPadaria.php" style="color: white;">A Padaria<span class="sr-only"></span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="faleConosco.php" style="color: white;">Fale Conosco<span class="sr-only"></span></a>
                </li>
            </ul>
